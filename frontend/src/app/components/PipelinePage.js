...
export default function PipelinePage() {
  ...
  return (
    <div className="page-transition p-4 md:p-8 space-y-6 relative z-10">
      {/* Header */}
      ...
      {activeView === 'analytics' && totalApps > 0 && (
        <div className="page-transition space-y-6">
          ...
          <div className="card-static p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 divide-y sm:divide-y-0 sm:divide-x divide-outline-variant/20">
              {[
