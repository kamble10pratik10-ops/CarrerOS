...
export default function MessagesPage({ initialUser, onUserSelect }) {
    ...
    return (
      <div className="flex h-full flex-col glass-panel">
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="w-80 border-r border-outline-variant/20 skeleton h-full" />
          <div className="flex-1 skeleton h-full" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex h-full flex-col glass-panel">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Conversation List */}
        <aside className="w-80 border-r border-outline-variant/20 flex flex-col overflow-hidden">
