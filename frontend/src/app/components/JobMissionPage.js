...
export default function JobMissionPage() {
  ...
  return (
    <div className="page-transition flex h-full relative z-10">
      {/* Left Panel — JD Input (35%) */}
      <div className="w-[35%] border-r border-outline-variant/20 flex flex-col p-6 space-y-6 bg-surface-container-low/25 backdrop-blur-md">
        <div>
      ...
      <div className="w-[65%] overflow-y-auto custom-scrollbar bg-surface-dim/30" ref={resultsRef}>
        {!result && !analyzing ? (
          /* Empty State */
