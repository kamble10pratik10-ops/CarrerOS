...
// ─── Problem Bank ───────────────────────────────────────────────────────────
const PROBLEMS = [
  { id: 'two-sum', title: 'Two Sum', difficulty: 'Easy', topic: 'Arrays', description: 'Given an array of integers `nums` and an integer `target`, return indices of the two numbers such that they add up to `target`.\n\nYou may assume that each input would have exactly one solution, and you may not use the same element twice.', examples: [{ input: 'nums = [2,7,11,15], target = 9', output: '[0,1]', explanation: 'Because nums[0] + nums[1] == 9' }], constraints: ['2 <= nums.length <= 10^4', '-10^9 <= nums[i] <= 10^9', 'Only one valid answer exists.'], testCases: [{ input: 'nums = [2,7,11,15], target = 9', expected: '[0,1]' }, { input: 'nums = [3,2,4], target = 6', expected: '[1,2]' }, { input: 'nums = [3,3], target = 6', expected: '[0,1]' }], starterCode: { python: 'def twoSum(nums, target):\n    # Your code here\n    pass', javascript: 'function twoSum(nums, target) {\n    // Your code here\n}', java: 'class Solution {\n    public int[] twoSum(int[] nums, int target) {\n        // Your code here\n        return new int[]{};\n    }\n}', cpp: 'class Solution {\npublic:\n    vector<int> twoSum(vector<int>& nums, int target) {\n        // Your code here\n        return {};\n    }\n};' }, tags: ['Hash Map', 'Array'] },
  { id: 'valid-parens', title: 'Valid Parentheses', difficulty: 'Easy', topic: 'Stacks & Queues', description: 'Given a string `s` containing just the characters `(`, `)`, `{`, `}`, `[` and `]`, determine if the input string is valid.\n\nAn input string is valid if:\n1. Open brackets must be closed by the same type of brackets.\n2. Open brackets must be closed in the correct order.\n3. Every close bracket has a corresponding open bracket of the same type.', examples: [{ input: 's = "()"', output: 'true' }, { input: 's = "()[]{}"', output: 'true' }, { input: 's = "(]"', output: 'false' }], constraints: ['1 <= s.length <= 10^4', 's consists of parentheses only'], testCases: [{ input: 's = "()"', expected: 'true' }, { input: 's = "()[]{}"', expected: 'true' }, { input: 's = "(]"', expected: 'false' }, { input: 's = "([)]"', expected: 'false' }], starterCode: { python: 'def isValid(s):\n    # Your code here\n    pass', javascript: 'function isValid(s) {\n    // Your code here\n}', java: 'class Solution {\n    public boolean isValid(String s) {\n        // Your code here\n        return false;\n    }\n}', cpp: 'class Solution {\npublic:\n    bool isValid(string s) {\n        // Your code here\n        return false;\n    }\n};' }, tags: ['Stack'] },
  { id: 'reverse-linked-list', title: 'Reverse Linked List', difficulty: 'Easy', topic: 'Linked Lists', description: 'Given the `head` of a singly linked list, reverse the list, and return the reversed list.', examples: [{ input: 'head = [1,2,3,4,5]', output: '[5,4,3,2,1]' }], constraints: ['The number of nodes is in [0, 5000]', '-5000 <= Node.val <= 5000'], testCases: [{ input: 'head = [1,2,3,4,5]', expected: '[5,4,3,2,1]' }, { input: 'head = [1,2]', expected: '[2,1]' }, { input: 'head = []', expected: '[]' }], starterCode: { python: 'def reverseList(head):\n    # Your code here\n    pass', javascript: 'function reverseList(head) {\n    // Your code here\n}', java: 'class Solution {\n    public ListNode reverseList(ListNode head) {\n        // Your code here\n        return null;\n    }\n}', cpp: 'class Solution {\npublic:\n    ListNode* reverseList(ListNode* head) {\n        // Your code here\n        return nullptr;\n    }\n};' }, tags: ['Linked List', 'Recursion'] },
  { id: 'max-depth-tree', title: 'Maximum Depth of Binary Tree', difficulty: 'Easy', topic: 'Trees', description: 'Given the `root` of a binary tree, return its maximum depth.\n\nA binary tree\'s maximum depth is the number of nodes along the longest path from the root node down to the farthest leaf node.', examples: [{ input: 'root = [3,9,20,null,null,15,7]', output: '3' }], constraints: ['The number of nodes is in [0, 10^4]', '-100 <= Node.val <= 100'], testCases: [{ input: 'root = [3,9,20,null,null,15,7]', expected: '3' }, { input: 'root = [1,null,2]', expected: '2' }], starterCode: { python: 'def maxDepth(root):\n    # Your code here\n    pass', javascript: 'function maxDepth(root) {\n    // Your code here\n}', java: 'class Solution {\n    public int maxDepth(TreeNode root) {\n        // Your code here\n        return 0;\n    }\n}', cpp: 'class Solution {\npublic:\n    int maxDepth(TreeNode* root) {\n        // Your code here\n        return 0;\n    }\n};' }, tags: ['Tree', 'DFS', 'BFS'] },
  { id: 'binary-search', title: 'Binary Search', difficulty: 'Easy', topic: 'Sorting & Searching', description: 'Given a sorted array of integers `nums` and a `target` value, return the index if the target is found. If not, return -1.\n\nYou must write an algorithm with O(log n) runtime complexity.', examples: [{ input: 'nums = [-1,0,3,5,9,12], target = 9', output: '4' }], constraints: ['1 <= nums.length <= 10^4', 'nums is sorted in ascending order'], testCases: [{ input: 'nums = [-1,0,3,5,9,12], target = 9', expected: '4' }, { input: 'nums = [-1,0,3,5,9,12], target = 2', expected: '-1' }], starterCode: { python: 'def search(nums, target):\n    # Your code here\n    pass', javascript: 'function search(nums, target) {\n    // Your code here\n}', java: 'class Solution {\n    public int search(int[] nums, int target) {\n        // Your code here\n        return -1;\n    }\n}', cpp: 'class Solution {\npublic:\n    int search(vector<int>& nums, int target) {\n        // Your code here\n        return -1;\n    }\n};' }, tags: ['Binary Search'] },
  { id: 'climbing-stairs', title: 'Climbing Stairs', difficulty: 'Easy', topic: 'Dynamic Programming', description: 'You are climbing a staircase. It takes `n` steps to reach the top.\n\nEach time you can either climb 1 or 2 steps. In how many distinct ways can you climb to the top?', examples: [{ input: 'n = 2', output: '2', explanation: '1+1 or 2' }, { input: 'n = 3', output: '3', explanation: '1+1+1, 1+2, 2+1' }], constraints: ['1 <= n <= 45'], testCases: [{ input: 'n = 2', expected: '2' }, { input: 'n = 3', expected: '3' }, { input: 'n = 5', expected: '8' }], starterCode: { python: 'def climbStairs(n):\n    # Your code here\n    pass', javascript: 'function climbStairs(n) {\n    // Your code here\n}', java: 'class Solution {\n    public int climbStairs(int n) {\n        // Your code here\n        return 0;\n    }\n}', cpp: 'class Solution {\npublic:\n    int climbStairs(int n) {\n        // Your code here\n        return 0;\n    }\n};' }, tags: ['DP', 'Fibonacci'] },
  { id: 'best-time-stock', title: 'Best Time to Buy and Sell Stock', difficulty: 'Easy', topic: 'Arrays', description: 'You are given an array `prices` where `prices[i]` is the price of a given stock on the ith day.\n\nYou want to maximize your profit by choosing a single day to buy one stock and choosing a different day in the future to sell that stock.\n\nReturn the maximum profit you can achieve from this transaction. If you cannot achieve any profit, return 0.', examples: [{ input: 'prices = [7,1,5,3,6,4]', output: '5', explanation: 'Buy on day 2 (price = 1) and sell on day 5 (price = 6)' }], constraints: ['1 <= prices.length <= 10^5'], testCases: [{ input: 'prices = [7,1,5,3,6,4]', expected: '5' }, { input: 'prices = [7,6,4,3,1]', expected: '0' }], starterCode: { python: 'def maxProfit(prices):\n    # Your code here\n    pass', javascript: 'function maxProfit(prices) {\n    // Your code here\n}', java: 'class Solution {\n    public int maxProfit(int[] prices) {\n        // Your code here\n        return 0;\n    }\n}', cpp: 'class Solution {\npublic:\n    int maxProfit(vector<int>& prices) {\n        // Your code here\n        return 0;\n    }\n};' }, tags: ['Array', 'Sliding Window'] },
  { id: 'merge-sorted-arrays', title: 'Merge Two Sorted Lists', difficulty: 'Easy', topic: 'Linked Lists', description: 'You are given the heads of two sorted linked lists `list1` and `list2`.\n\nMerge the two lists into one sorted list. The list should be made by splicing together the nodes of the first two lists.\n\nReturn the head of the merged linked list.', examples: [{ input: 'list1 = [1,2,4], list2 = [1,3,4]', output: '[1,1,2,3,4,4]' }], constraints: ['The number of nodes in both lists is in [0, 50]'], testCases: [{ input: 'list1 = [1,2,4], list2 = [1,3,4]', expected: '[1,1,2,3,4,4]' }, { input: 'list1 = [], list2 = []', expected: '[]' }], starterCode: { python: 'def mergeTwoLists(list1, list2):\n    # Your code here\n    pass', javascript: 'function mergeTwoLists(list1, list2) {\n    // Your code here\n}', java: 'class Solution {\n    public ListNode mergeTwoLists(ListNode list1, ListNode list2) {\n        return null;\n    }\n}', cpp: 'class Solution {\npublic:\n    ListNode* mergeTwoLists(ListNode* list1, ListNode* list2) {\n        return nullptr;\n    }\n};' }, tags: ['Linked List', 'Recursion'] },
  { id: 'contains-duplicate', title: 'Contains Duplicate', difficulty: 'Easy', topic: 'Arrays', description: 'Given an integer array `nums`, return `true` if any value appears at least twice in the array, and return `false` if every element is distinct.', examples: [{ input: 'nums = [1,2,3,1]', output: 'true' }, { input: 'nums = [1,2,3,4]', output: 'false' }], constraints: ['1 <= nums.length <= 10^5'], testCases: [{ input: 'nums = [1,2,3,1]', expected: 'true' }, { input: 'nums = [1,2,3,4]', expected: 'false' }], starterCode: { python: 'def containsDuplicate(nums):\n    # Your code here\n    pass', javascript: 'function containsDuplicate(nums) {\n    // Your code here\n}', java: 'class Solution {\n    public boolean containsDuplicate(int[] nums) {\n        return false;\n    }\n}', cpp: 'class Solution {\npublic:\n    bool containsDuplicate(vector<int>& nums) {\n        return false;\n    }\n};' }, tags: ['Hash Set', 'Sorting'] },
  { id: 'valid-anagram', title: 'Valid Anagram', difficulty: 'Easy', topic: 'Strings', description: 'Given two strings `s` and `t`, return `true` if `t` is an anagram of `s`, and `false` otherwise.', examples: [{ input: 's = "anagram", t = "nagaram"', output: 'true' }], constraints: ['1 <= s.length, t.length <= 5 * 10^4'], testCases: [{ input: 's = "anagram", t = "nagaram"', expected: 'true' }, { input: 's = "rat", t = "car"', expected: 'false' }], starterCode: { python: 'def isAnagram(s, t):\n    # Your code here\n    pass', javascript: 'function isAnagram(s, t) {\n    // Your code here\n}', java: 'class Solution {\n    public boolean isAnagram(String s, String t) {\n        return false;\n    }\n}', cpp: 'class Solution {\npublic:\n    bool isAnagram(string s, string t) {\n        return false;\n    }\n};' }, tags: ['Hash Map', 'Sorting'] },
  // Medium
  { id: 'longest-substring', title: 'Longest Substring Without Repeating', difficulty: 'Medium', topic: 'Strings', description: 'Given a string `s`, find the length of the longest substring without repeating characters.', examples: [{ input: 's = "abcabcbb"', output: '3', explanation: 'The answer is "abc"' }], constraints: ['0 <= s.length <= 5 * 10^4'], testCases: [{ input: 's = "abcabcbb"', expected: '3' }, { input: 's = "bbbbb"', expected: '1' }, { input: 's = "pwwkew"', expected: '3' }], starterCode: { python: 'def lengthOfLongestSubstring(s):\n    # Your code here\n    pass', javascript: 'function lengthOfLongestSubstring(s) {\n    // Your code here\n}', java: 'class Solution {\n    public int lengthOfLongestSubstring(String s) {\n        return 0;\n    }\n}', cpp: 'class Solution {\npublic:\n    int lengthOfLongestSubstring(string s) {\n        return 0;\n    }\n};' }, tags: ['Sliding Window', 'Hash Map'] },
  { id: 'three-sum', title: '3Sum', difficulty: 'Medium', topic: 'Arrays', description: 'Given an integer array nums, return all the triplets `[nums[i], nums[j], nums[k]]` such that `i != j`, `i != k`, and `j != k`, and `nums[i] + nums[j] + nums[k] == 0`.\n\nThe solution set must not contain duplicate triplets.', examples: [{ input: 'nums = [-1,0,1,2,-1,-4]', output: '[[-1,-1,2],[-1,0,1]]' }], constraints: ['3 <= nums.length <= 3000'], testCases: [{ input: 'nums = [-1,0,1,2,-1,-4]', expected: '[[-1,-1,2],[-1,0,1]]' }, { input: 'nums = [0,1,1]', expected: '[]' }], starterCode: { python: 'def threeSum(nums):\n    # Your code here\n    pass', javascript: 'function threeSum(nums) {\n    // Your code here\n}', java: 'class Solution {\n    public List<List<Integer>> threeSum(int[] nums) {\n        return new ArrayList<>();\n    }\n}', cpp: 'class Solution {\npublic:\n    vector<vector<int>> threeSum(vector<int>& nums) {\n        return {};\n    }\n};' }, tags: ['Two Pointers', 'Sorting'] },
  { id: 'lru-cache', title: 'LRU Cache', difficulty: 'Medium', topic: 'Stacks & Queues', description: 'Design a data structure that follows the constraints of a Least Recently Used (LRU) cache.\n\nImplement the `LRUCache` class:\n- `LRUCache(int capacity)` Initialize the cache with positive size capacity.\n- `int get(int key)` Return the value if the key exists, otherwise return -1.\n- `void put(int key, int value)` Update or insert the value. When the cache reaches its capacity, evict the least recently used key.', examples: [{ input: 'LRUCache(2), put(1,1), put(2,2), get(1), put(3,3), get(2)', output: '1, -1' }], constraints: ['1 <= capacity <= 3000', 'At most 2 * 10^5 calls'], testCases: [{ input: 'LRUCache(2), put(1,1), put(2,2), get(1), put(3,3), get(2)', expected: 'get(1)=1, get(2)=-1' }], starterCode: { python: 'class LRUCache:\n    def __init__(self, capacity):\n        pass\n    \n    def get(self, key):\n        pass\n    \n    def put(self, key, value):\n        pass', javascript: 'class LRUCache {\n    constructor(capacity) {\n    }\n    get(key) {\n    }\n    put(key, value) {\n    }\n}', java: 'class LRUCache {\n    public LRUCache(int capacity) {\n    }\n    public int get(int key) {\n        return -1;\n    }\n    public void put(int key, int value) {\n    }\n}', cpp: 'class LRUCache {\npublic:\n    LRUCache(int capacity) {\n    }\n    int get(int key) {\n        return -1;\n    }\n    void put(int key, int value) {\n    }\n};' }, tags: ['Hash Map', 'Doubly Linked List', 'Design'] },
  { id: 'number-of-islands', title: 'Number of Islands', difficulty: 'Medium', topic: 'Graphs', description: 'Given an m x n 2D binary grid which represents a map of \'1\'s (land) and \'0\'s (water), return the number of islands.\n\nAn island is surrounded by water and is formed by connecting adjacent lands horizontally or vertically.', examples: [{ input: 'grid = [["1","1","0"],["1","1","0"],["0","0","1"]]', output: '2' }], constraints: ['m == grid.length', 'n == grid[i].length', '1 <= m, n <= 300'], testCases: [{ input: 'grid = [["1","1","0"],["1","1","0"],["0","0","1"]]', expected: '2' }], starterCode: { python: 'def numIslands(grid):\n    # Your code here\n    pass', javascript: 'function numIslands(grid) {\n    // Your code here\n}', java: 'class Solution {\n    public int numIslands(char[][] grid) {\n        return 0;\n    }\n}', cpp: 'class Solution {\npublic:\n    int numIslands(vector<vector<char>>& grid) {\n        return 0;\n    }\n};' }, tags: ['BFS', 'DFS', 'Graph'] },
  { id: 'coin-change', title: 'Coin Change', difficulty: 'Medium', topic: 'Dynamic Programming', description: 'Given an array `coins` representing coin denominations and an integer `amount`, return the fewest number of coins needed to make up that amount. If that amount cannot be made up, return -1.\n\nYou may assume that you have an infinite number of each kind of coin.', examples: [{ input: 'coins = [1,5,10], amount = 12', output: '3', explanation: '10 + 1 + 1' }], constraints: ['1 <= coins.length <= 12', '0 <= amount <= 10^4'], testCases: [{ input: 'coins = [1,5,10], amount = 12', expected: '3' }, { input: 'coins = [2], amount = 3', expected: '-1' }, { input: 'coins = [1], amount = 0', expected: '0' }], starterCode: { python: 'def coinChange(coins, amount):\n    # Your code here\n    pass', javascript: 'function coinChange(coins, amount) {\n    // Your code here\n}', java: 'class Solution {\n    public int coinChange(int[] coins, int amount) {\n        return -1;\n    }\n}', cpp: 'class Solution {\npublic:\n    int coinChange(vector<int>& coins, int amount) {\n        return -1;\n    }\n};' }, tags: ['DP', 'BFS'] },
  { id: 'validate-bst', title: 'Validate Binary Search Tree', difficulty: 'Medium', topic: 'Trees', description: 'Given the `root` of a binary tree, determine if it is a valid binary search tree (BST).', examples: [{ input: 'root = [2,1,3]', output: 'true' }, { input: 'root = [5,1,4,null,null,3,6]', output: 'false' }], constraints: ['The number of nodes in the tree is in [1, 10^4]'], testCases: [{ input: 'root = [2,1,3]', expected: 'true' }, { input: 'root = [5,1,4,null,null,3,6]', expected: 'false' }], starterCode: { python: 'def isValidBST(root):\n    # Your code here\n    pass', javascript: 'function isValidBST(root) {\n    // Your code here\n}', java: 'class Solution {\n    public boolean isValidBST(TreeNode root) {\n        return false;\n    }\n}', cpp: 'class Solution {\npublic:\n    bool isValidBST(TreeNode* root) {\n        return false;\n    }\n};' }, tags: ['Tree', 'DFS', 'BST'] },
  { id: 'group-anagrams', title: 'Group Anagrams', difficulty: 'Medium', topic: 'Strings', description: 'Given an array of strings `strs`, group the anagrams together. You can return the answer in any order.', examples: [{ input: 'strs = ["eat","tea","tan","ate","nat","bat"]', output: '[["bat"],["nat","tan"],["ate","eat","tea"]]' }], constraints: ['1 <= strs.length <= 10^4'], testCases: [{ input: 'strs = ["eat","tea","tan","ate","nat","bat"]', expected: '[["bat"],["nat","tan"],["ate","eat","tea"]]' }, { input: 'strs = [""]', expected: '[[""]]' }], starterCode: { python: 'def groupAnagrams(strs):\n    # Your code here\n    pass', javascript: 'function groupAnagrams(strs) {\n    // Your code here\n}', java: 'class Solution {\n    public List<List<String>> groupAnagrams(String[] strs) {\n        return new ArrayList<>();\n    }\n}', cpp: 'class Solution {\npublic:\n    vector<vector<string>> groupAnagrams(vector<string>& strs) {\n        return {};\n    }\n};' }, tags: ['Hash Map', 'Sorting'] },
  { id: 'merge-intervals', title: 'Merge Intervals', difficulty: 'Medium', topic: 'Sorting & Searching', description: 'Given an array of `intervals` where `intervals[i] = [starti, endi]`, merge all overlapping intervals, and return an array of the non-overlapping intervals that cover all the intervals in the input.', examples: [{ input: 'intervals = [[1,3],[2,6],[8,10],[15,18]]', output: '[[1,6],[8,10],[15,18]]' }], constraints: ['1 <= intervals.length <= 10^4'], testCases: [{ input: 'intervals = [[1,3],[2,6],[8,10],[15,18]]', expected: '[[1,6],[8,10],[15,18]]' }, { input: 'intervals = [[1,4],[4,5]]', expected: '[[1,5]]' }], starterCode: { python: 'def merge(intervals):\n    # Your code here\n    pass', javascript: 'function merge(intervals) {\n    // Your code here\n}', java: 'class Solution {\n    public int[][] merge(int[][] intervals) {\n        return new int[][]{};\n    }\n}', cpp: 'class Solution {\npublic:\n    vector<vector<int>> merge(vector<vector<int>>& intervals) {\n        return {};\n    }\n};' }, tags: ['Sorting', 'Intervals'] },
  // Hard
  { id: 'median-sorted-arrays', title: 'Median of Two Sorted Arrays', difficulty: 'Hard', topic: 'Sorting & Searching', description: 'Given two sorted arrays `nums1` and `nums2` of size m and n respectively, return the median of the two sorted arrays.\n\nThe overall run time complexity should be O(log (m+n)).', examples: [{ input: 'nums1 = [1,3], nums2 = [2]', output: '2.0' }], constraints: ['0 <= m,n <= 1000', 'nums1 and nums2 are sorted'], testCases: [{ input: 'nums1 = [1,3], nums2 = [2]', expected: '2.0' }, { input: 'nums1 = [1,2], nums2 = [3,4]', expected: '2.5' }], starterCode: { python: 'def findMedianSortedArrays(nums1, nums2):\n    # Your code here\n    pass', javascript: 'function findMedianSortedArrays(nums1, nums2) {\n    // Your code here\n}', java: 'class Solution {\n    public double findMedianSortedArrays(int[] nums1, int[] nums2) {\n        return 0.0;\n    }\n}', cpp: 'class Solution {\npublic:\n    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {\n        return 0.0;\n    }\n};' }, tags: ['Binary Search', 'Divide and Conquer'] },
  { id: 'merge-k-sorted', title: 'Merge k Sorted Lists', difficulty: 'Hard', topic: 'Linked Lists', description: 'You are given an array of `k` linked-lists `lists`, each linked-list is sorted in ascending order.\n\nMerge all the linked-lists into one sorted linked-list and return it.', examples: [{ input: 'lists = [[1,4,5],[1,3,4],[2,6]]', output: '[1,1,2,3,4,4,5,6]' }], constraints: ['k == lists.length', '0 <= k <= 10^4'], testCases: [{ input: 'lists = [[1,4,5],[1,3,4],[2,6]]', expected: '[1,1,2,3,4,4,5,6]' }], starterCode: { python: 'def mergeKLists(lists):\n    # Your code here\n    pass', javascript: 'function mergeKLists(lists) {\n    // Your code here\n}', java: 'class Solution {\n    public ListNode mergeKLists(ListNode[] lists) {\n        return null;\n    }\n}', cpp: 'class Solution {\npublic:\n    ListNode* mergeKLists(vector<ListNode*>& lists) {\n        return nullptr;\n    }\n};' }, tags: ['Heap', 'Linked List', 'Divide and Conquer'] },
  { id: 'word-ladder', title: 'Word Ladder', difficulty: 'Hard', topic: 'Graphs', description: 'A transformation sequence from word `beginWord` to word `endWord` using a dictionary `wordList` is a sequence of words `beginWord -> s1 -> s2 -> ... -> sk` such that every adjacent pair of words differs by a single letter.\n\nGiven two words `beginWord` and `endWord`, and a dictionary `wordList`, return the number of words in the shortest transformation sequence, or 0 if no such sequence exists.', examples: [{ input: 'beginWord = "hit", endWord = "cog", wordList = ["hot","dot","dog","lot","log","cog"]', output: '5' }], constraints: ['1 <= beginWord.length <= 10', 'All words have the same length'], testCases: [{ input: 'beginWord = "hit", endWord = "cog", wordList = ["hot","dot","dog","lot","log","cog"]', expected: '5' }], starterCode: { python: 'def ladderLength(beginWord, endWord, wordList):\n    # Your code here\n    pass', javascript: 'function ladderLength(beginWord, endWord, wordList) {\n    // Your code here\n}', java: 'class Solution {\n    public int ladderLength(String beginWord, String endWord, List<String> wordList) {\n        return 0;\n    }\n}', cpp: 'class Solution {\npublic:\n    int ladderLength(string beginWord, string endWord, vector<string>& wordList) {\n        return 0;\n    }\n};' }, tags: ['BFS', 'Graph'] },
  { id: 'longest-increasing-subseq', title: 'Longest Increasing Subsequence', difficulty: 'Medium', topic: 'Dynamic Programming', description: 'Given an integer array `nums`, return the length of the longest strictly increasing subsequence.', examples: [{ input: 'nums = [10,9,2,5,3,7,101,18]', output: '4', explanation: 'The LIS is [2,3,7,101]' }], constraints: ['1 <= nums.length <= 2500'], testCases: [{ input: 'nums = [10,9,2,5,3,7,101,18]', expected: '4' }, { input: 'nums = [0,1,0,3,2,3]', expected: '4' }], starterCode: { python: 'def lengthOfLIS(nums):\n    # Your code here\n    pass', javascript: 'function lengthOfLIS(nums) {\n    // Your code here\n}', java: 'class Solution {\n    public int lengthOfLIS(int[] nums) {\n        return 0;\n    }\n}', cpp: 'class Solution {\npublic:\n    int lengthOfLIS(vector<int>& nums) {\n        return 0;\n    }\n};' }, tags: ['DP', 'Binary Search'] },
  { id: 'course-schedule', title: 'Course Schedule', difficulty: 'Medium', topic: 'Graphs', description: 'There are a total of `numCourses` courses you have to take, labeled from 0 to numCourses - 1. You are given an array `prerequisites` where `prerequisites[i] = [ai, bi]` indicates that you must take course bi first if you want to take course ai.\n\nReturn true if you can finish all courses. Otherwise, return false.', examples: [{ input: 'numCourses = 2, prerequisites = [[1,0]]', output: 'true' }], constraints: ['1 <= numCourses <= 2000'], testCases: [{ input: 'numCourses = 2, prerequisites = [[1,0]]', expected: 'true' }, { input: 'numCourses = 2, prerequisites = [[1,0],[0,1]]', expected: 'false' }], starterCode: { python: 'def canFinish(numCourses, prerequisites):\n    # Your code here\n    pass', javascript: 'function canFinish(numCourses, prerequisites) {\n    // Your code here\n}', java: 'class Solution {\n    public boolean canFinish(int numCourses, int[][] prerequisites) {\n        return false;\n    }\n}', cpp: 'class Solution {\npublic:\n    bool canFinish(int numCourses, vector<vector<int>>& prerequisites) {\n        return false;\n    }\n};' }, tags: ['Topological Sort', 'BFS', 'DFS'] },
];
